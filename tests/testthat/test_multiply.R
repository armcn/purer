...
test_that("%*ss%% multiplies numbers", {
...
test_that("%*ss% throws if integers and doubles are multiplied", {
...
test_that("%*vv% multiplies numbers", {
...
test_that("%*vv% throws if integers and doubles are multiplied", {
...
test_that("%*sv% multiplies numbers", {
...
test_that("%*sv% throws if integers and doubles are multiplied", {
...
test_that("%*vs% multiplies numbers", {
...
test_that("%*vs% throws if integers and doubles are multiplied", {
